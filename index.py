...
# st.caption("Project showcases the general data and stats of the election in interactive way.")
...
folium.GeoJsonTooltip(fields=["pc_name"],style=("background-color: white; color: #333333; font-family: arial; font-size: 12px; padding: 10px;")).add_to(g)
st_data  = st_folium(m, width=700)
# If using Jupyter Notebook, display the map inline
# m
def get_pos(lat, lng):
